...
<nav class="navbar navbar-expand-lg navbar-light bg-light primary-background text-white fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"><a  class="nav-link "  href="viewcomplain.jsp">Viewcompain</a>
      
      </li>
      </ul> <ul class="navbar-nav mr-right">
 ...
 <a class="nav-link" href="#!" data-toggle="modal" data-target="#profile-modal">
    ...
    </div></nav><main style="background-color:"background-color:#007bff85;"></main>
      <div class=" container ml-20 mt-5rem">
...
for(Assigncom ass:as){
	%>    
	<tr>
	<td><%=ass.getComplainid() %></td>
	<td><%=ass.getEmployeeid() %></td>
...
</tbody> </table></div></div></div></div></main> <!-- Modal -->
