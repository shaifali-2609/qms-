...
<nav class="navbar navbar-expand-lg navbar-light bg-light primary-background text-white fixed-top">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item"><a  class="nav-link "  href="viewcomplain.jsp">View complain</a>
...
<div class="container ml-20 mt-5 p-5 ">
...
List<Reply> rep=dao.getallreply();

for(Reply re:rep ){
	%>
	<tr>
	<td><%=re.getCustomeremail() %></td>
	<td><%=re.getComplainid() %></td>
	<td><%=re.getEmpId() %></td>
	<td><%=re.getReplyMessage() %></td>
	<td><%=re.getReplyId() %>
	</tr>
	<% }
...
</tbody></table></div></div></div></div><!-- Modal -->
